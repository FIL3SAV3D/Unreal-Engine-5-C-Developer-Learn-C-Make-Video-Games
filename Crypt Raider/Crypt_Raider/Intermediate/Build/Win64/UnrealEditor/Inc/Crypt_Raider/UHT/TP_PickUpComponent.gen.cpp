...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature_Statics::NewProp_PickUpCharacter = { "PickUpCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_Crypt_Raider_eventOnPickUp_Parms, PickUpCharacter), Z_Construct_UClass_ACrypt_RaiderCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Crypt_Raider, nullptr, "OnPickUp__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature_Statics::_Script_Crypt_Raider_eventOnPickUp_Parms), Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp = { "OnPickUp", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UTP_PickUpComponent, OnPickUp), Z_Construct_UDelegateFunction_Crypt_Raider_OnPickUp__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp_MetaData)) }; // 35452468
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Engine_5_Projects_Crypt_Raider_Crypt_Raider_Source_Crypt_Raider_TP_PickUpComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Engine_5_Projects_Crypt_Raider_Crypt_Raider_Source_Crypt_Raider_TP_PickUpComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_PickUpComponent, UTP_PickUpComponent::StaticClass, TEXT("UTP_PickUpComponent"), &Z_Registration_Info_UClass_UTP_PickUpComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_PickUpComponent), 315248830U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Engine_5_Projects_Crypt_Raider_Crypt_Raider_Source_Crypt_Raider_TP_PickUpComponent_h_1770418223(TEXT("/Script/Crypt_Raider"),
		Z_CompiledInDeferFile_FID_Unreal_Engine_5_Projects_Crypt_Raider_Crypt_Raider_Source_Crypt_Raider_TP_PickUpComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Engine_5_Projects_Crypt_Raider_Crypt_Raider_Source_Crypt_Raider_TP_PickUpComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
